...
function resolvePaymentsColMap(sh) {
  ...
  return {
    ...
    SERVICO: pick('SERVICO','SERVIÇO','CATEGORIA DE SERVIÇO','CATEGORIA DE SERVICO','SERVICO REALIZADO','DESCRICAO','DESCRIÇÃO'),
    PARCELA_NUM: pick('PARCELA_NUM','PARCELA'),
    TOTAL_SERVICO: pick('TOTAL_SERVICO','VALOR_TOTAL_SERVICO','VALOR_TOTAL','TOTAL_SERVICO','TOTAL'),
    VALOR: pick('VALOR DO PGTO','VALOR_PGTO','VALOR DO PAGAMENTO','VALOR_PAGAMENTO','VALOR','VALOR_PARCELA'),
    DATA_PREVISTA: pick('DATA_PREVISTA','DATA_PREVISTO','DATA'),
    DATA_PAGAMENTO: pick('DATA_PAGAMENTO','DATA_PAGO','DATA'),
    STATUS: pick('STATUS','STATUS DO PAGAMENTO','STATUS PAGAMENTO'),
...
function criarAbaPagamentosSimples() {
  ...
  const headers = [
    'PAYMENT_UUID','CHAVE','EMPREENDIMENTO','UNIDADE','CATEGORIA DE SERVIÇO','PRESTADOR',
